package org.oberon.oss.chess.game.base.field;
...
class ChessFieldTest {
    ...
    @ParameterizedTest
    @MethodSource("org.oberon.oss.chess.game.base.field.util.MethodSources#getRankFields")
    void getRankFields(int rank, List<ChessField> target) {
        assertTrue(CBRanks.getRank(rank).getFields().containsAll(target));
    }

    @ParameterizedTest
    @MethodSource("org.oberon.oss.chess.game.base.field.util.MethodSources#getFileFields")
    void getFileFields(String file, List<ChessField> target) {
        assertTrue(CBFiles.getFile(file).getFields().containsAll(target));
    }

    @ParameterizedTest
    @MethodSource("org.oberon.oss.chess.game.base.field.util.MethodSources#getFieldByCoordinates")
